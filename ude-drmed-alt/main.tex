...
\usepackage[backend=biber, style=ude-cite-promoord-alt]{biblatex}
...
Es sollte mal einen bib-Datei geben, die zumindest für @book und @article ENTRYTYPES alle möglichen Felder beinhaltet mit Feldinhalt wie Feldname, wie zum Beispiel hier \cite{einbuchmitallenfeldern}. Das habe ich auch mit englischen Inhalten \cite{abookwithallfields}.
